...
def test_hash():
    ...
    k.update(pt)
    h2 = k.hexdigest()
    assert h == b'8630c13cbd066ea74bbe7fe468fec1dee10edc1254fb4c1b7c5fd69b646e44160b8ce01d05a0908ca790dfb080f4b513bc3b6225ece7a810371441a5ac666eb9'
    assert h == h2

def test_multipart():
    pt = unhexlify('41fb')
    expect = b'615ba367afdc35aac397bc7eb5d58d106a734b24986d5d978fefd62c'
    h = Keccak224()
    h.update(pt[:1])
...
def test_long():
    ...
    expect = b'230620d710cf3ab835059e1aa170735db17cae74b345765ff02e8d89'
